...
Usage
-----
- `@create_missing_foreign_key_indexes.sql '{ table_prefix:"",     dry_run:""     }'` (all tables, do the intended work)
- `@create_missing_foreign_key_indexes.sql '{ table_prefix:"",     dry_run:"true" }'` (all tables, report only)
- `@create_missing_foreign_key_indexes.sql '{ table_prefix:"OEHR", dry_run:""     }'` (only for tables prefixed with "OEHR")
- `@create_missing_foreign_key_indexes.sql '{ table_prefix:"CO",   dry_run:"test" }'` (only for tables prefixed with "CO", report only)

Meta
----
- Author: [Ottmar Gobrecht](https://ogobrecht.github.io)
- Script: [create_missing_foreign_key_indexes.sql](https://github.com/ogobrecht/oracle-sql-scripts/blob/master/scripts/create_missing_foreign_key_indexes.sql)
