...
Usage
-----
- `@enable_all_foreign_key_constraints.sql "" ""` (for all tables, do the intended work)
- `@enable_all_foreign_key_constraints.sql "" "dry run"` (for all tables, report only)
- `@enable_all_foreign_key_constraints.sql "OEHR" ""` (only for tables prefixed with "OEHR")
- `@enable_all_foreign_key_constraints.sql "CO" "test"` (only for tables prefixed with "CO", report only)
