...
begin
  ...
  if v_count = 0 then
    dbms_output.put_line('- table users, 2 rows');
    ...
    dbms_output.put_line('- table users, 0 rows (table contains already data)');
  end if;

  select count(*) into v_count from map_users_roles;
  if v_count = 0 then
    dbms_output.put_line('- table map_users_roles, 2 rows');
    ...
    dbms_output.put_line('- table map_users_roles, 0 rows (table contains already data)');
  end if;

  select count(*) into v_count from roles;
  if v_count = 0 then
    dbms_output.put_line('- table roles, 4 rows');
    ...
    dbms_output.put_line('- table roles, 0 rows (table contains already data)');
  end if;

  select count(*) into v_count from map_roles_rights;
  if v_count = 0 then
    dbms_output.put_line('- table map_roles_rights, 10 rows');
    ...
    dbms_output.put_line('- table map_roles_rights, 0 rows (table contains already data)');
  end if;

  select count(*) into v_count from rights;
  if v_count = 0 then
    dbms_output.put_line('- table rights, 4 rows');
    ...
    dbms_output.put_line('- table rights, 0 rows (table contains already data)');
  end if;
